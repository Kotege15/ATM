...
public class Main {
    ...
    public static void page(){
        ...
        else if ( data.user2.accountnumber == inputnumber && user2.accountpin == inputpin){
            DisplayU2.screen1 ();
        }
        else if ( data.user.accountnumber == inputnumber && user.accountpin == inputpin){
            Mainp.User01.DisplayU1.screen1 ();
        }
        else if (inputnumber == data.user4.accountnumber && user4.accountpin == inputpin){
            DisplayU4.screen1 ();
        }
